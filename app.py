...
client = MongoClient('mongodb+srv://test:sparta@cluster0.wr6anws.mongodb.net/Cluster0?retryWrites=true&w=majority', tlsCAFile=ca)
db = client.dbsparta
...
def home():
    ...
    try:
        ...
        return render_template('index.html', all_users=all_users, videos=videos, nickname=user_info['nickname'])
...
def posting():
    ...
    try:
        ...
        embed = url_receive.split('&')[0].replace('watch?v=', 'embed/')
